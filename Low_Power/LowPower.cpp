...
* 1.80      Added support for ATmega88P and ATmega168P. PowerExtStandby()
*           modified because not supported on ATmega88P / Atmega168
...
*
*******************************************************************************/
#if defined (__AVR_ATmega328P__) || defined (__AVR_ATmega168__) || defined (__AVR_ATmega168P__) || defined (__AVR_ATmega88P__)
...
*              Not implemented on ATmega88P and Atmega168.
*
* Argument  	Description
* =========  	===========
* 1. period     Duration of low power mode. Use SLEEP_FOREVER to use other wake
									   ...
									   timer2_t timer2)
{
	...
	#if defined (__AVR_ATmega88P__) || defined (__AVR_ATmega168__) // SLEEP_MODE_EXT_STANDBY not implemented on ATmega88P / Atmega168
	#else
		if (bod == BOD_OFF)
		{
			#if defined (__AVR_ATmega328P__) || defined (__AVR_ATmega168P__)
